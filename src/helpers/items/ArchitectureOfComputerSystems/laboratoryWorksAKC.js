...
const LaboratoryWorksAKC = [
   ...
   },
   {
   ...
   },
    {
     ...
     textWork: "Для допуску к ЛБ№3 вам потрібно зробити 3 задачі за номером своєї бригади, потрібно зробити перше, друге та четверте завдання (самі задачи знаходяться : Корисні файли -> АКС_04_FPU_)",
     countingDays: calculateDaysLeft("02.05.2023"), // Дата сдачи задания
   },
];
