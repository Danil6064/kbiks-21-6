...
Під час виконання пункту 2 ("Підготовка сторінки проєкту в сервісі Google Docs") доступ на коментування надайте викладачеві Шафоростову (mykhailo.shaforostov@nure.ua) й викладачеві Ляшенку (oleksii.liashenko@nure.ua <oleksii.liashenko@nure.ua>). Запрошення на спільну роботу (сповіщення) не надсилайте.\n
